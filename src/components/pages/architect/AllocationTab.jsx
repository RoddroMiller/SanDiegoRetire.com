                ...
                <div className="h-80 w-full">
                  <ResponsiveContainer width="100%" height="100%">
                    <ComposedChart data={mcChartData}>
                      ...
                      {inputs.showBenchmark && <Line type="monotone" dataKey="benchmark" name="Passive 60/40" stroke={COLORS.benchmark} strokeDasharray="3 3" strokeWidth={1.5} dot={false} />}
                    </ComposedChart>
                  </ResponsiveContainer>
                </div>
            ...
            <>
              <div className="h-80 w-full">
                <ResponsiveContainer width="100%" height="100%">
                  <ComposedChart data={projectionData}>
                    ...
                    {inputs.showBenchmark && <Line type="monotone" dataKey="benchmark" name="Passive 60/40 (Annual Rebalance)" stroke={COLORS.benchmark} strokeDasharray="5 5" strokeWidth={2} dot={false} />}
              ...
              <div className="mt-4 p-3 bg-mwm-gold/10 text-xs text-mwm-gold/80 rounded border border-mwm-gold/20 flex items-start gap-2">
                ...
                <p>
                  ...
                  {inputs.showBenchmark && <><strong>Gold Line:</strong> Passive 60/40 with annual rebalance for comparison. <br /></>}
